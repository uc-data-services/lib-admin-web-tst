 ...
 */
function las_seven_preprocess_maintenance_page(&$vars) {
  // While markup for normal pages is split into page.tpl.php and html.tpl.php,
  // the markup for the maintenance page is all in the single
  // maintenance-page.tpl.php template. So, to have what's done in
  // seven_preprocess_html() also happen on the maintenance page, it has to be
  // called here.
  las_seven_preprocess_html($vars);
}

/**
 * Override or insert variables into the html template.
 */
function las_seven_preprocess_html(&$vars) {
 ...
 */
function las_seven_preprocess_page(&$vars) {
 ...
 */
function las_seven_node_add_list($variables) {
 ...
 */
function las_seven_admin_block_content($variables) {
  $content = $variables['content'];
  $output = '';
  if (!empty($content)) {
 ...
 */
function las_seven_tablesort_indicator($variables) {
  $style = $variables['style'];
  $theme_path = drupal_get_path('theme', 'las_seven');
  if ($style == 'asc') {
 ...
 */
function las_seven_css_alter(&$css) {
